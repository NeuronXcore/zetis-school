...
MVP livré — **étapes 1 → 12** du `SUIVI_DEVELOPPEMENT_ZETIS.md`. Correspondance avec les phases :
...
- ⬜ **Phases 4, 8-12** : à venir (diagnostic complet, capsules, vocal, accès distant, multi-enfant).
