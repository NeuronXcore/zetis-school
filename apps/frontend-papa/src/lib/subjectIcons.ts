// Résolution des icônes PNG de matières (apps/frontend-papa/src/assets/subjects,
// copiées à l'identique depuis le frontend Massimo pour une identité visuelle commune).
